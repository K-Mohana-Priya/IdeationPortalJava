...
<a href="adminnotification.jsp" class='col-lg-12 col-md-12 col-sm-12' style="background-color:#dfdfdf">View Notifications</a><br>
</div>
<div class="col-lg-10 col-md-10 col-sm-9 equaliseheight">	
  
  <form action="deletenotecontroller" method="post" id="todelete">
  <input type="hidden" id="ticked" name="ticked" value="" />
  <h2>Notifications</h2>
  <table class="table table-hover">
  <thead><tr><th>Notification</th><th>Delete</th></tr></thead>
  <tbody>
   <sql:query dataSource="${myidea}" var="result" >
	...
	<tr>
	<td>${res1.notification_data }</td><td><button type="button" class="btn btn-default"  onclick="addDeleteHandler(this)" value="${res1.notification_id }" ><span class="glyphicon glyphicon-trash"></span></button></td></tr>
	</c:forEach>
