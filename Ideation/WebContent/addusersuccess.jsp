...
<script>
history.pushState(null,null,"addusersuccess.jsp");
...
<a href="adminhome.jsp" class='col-lg-12 col-md-12 col-sm-12' style="background-color:#dfdfdf">Add Single User</a><br>
...
<h2 style="color:blue">User Successfully Added!</h2>
