...
<form role="form" id="reg" action="editusercontroller" method="post" onsubmit="return validate()">
    ...
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      ...
      <input type="text" class="form-control" id="man1" name="man1" value="${requestScope.euser.getManager_id_1()}">
      <span id=fman1_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="man2">Manager id 2:</label>
      <input type="text" class="form-control" id="man2" name="man2" value="${requestScope.euser.getManager_id_2()}">
      <span id=fman2_msg style="color:red"></span><br>
    </div><br><br>

    <div class="centered">
    <button type="submit" class="btn btn-default" id="butt">Edit</button>
    <a class="btn btn-default" href="editusers.jsp">Cancel</a>
    </div>
  </form>
  <script>
        function validate()
