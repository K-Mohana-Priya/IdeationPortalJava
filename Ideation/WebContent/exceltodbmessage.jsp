...
<title>Excel to Db Message</title>
<style>
.col-centered{
    margin: 0 auto;
    float: none;
...
<script>
history.pushState(null,null,"exceltodbmessage.jsp");
...
<h3>In case of any error messages do the following.</h3>
<p>1. Correct the errors and copy only the corrected rows to a new file and upload it again. This will ensure that the error message "user id already exists" does not appear.</p>
<p>2. "user id already exists" message can be ignored unless the user id field is null or erroneous.</p>
<div style="color:red">
