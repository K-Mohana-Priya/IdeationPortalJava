...
function servletreq(s)
{
	...
	var n = s.cells[1].innerHTML;
	document.location="viewgroup.jsp?gid="+i+"&gname="+n;
}
...
<a href="viewgroups.jsp" class='col-lg-12 col-md-12 col-sm-12' style="background-color:#dfdfdf">View Groups</a><br>
...
<h3>Click on a group to view it's members!</h3><br>
