...
<a href="adminmessage.jsp" class='col-lg-12 col-md-12 col-sm-12'>Send Messages</a><br>
...
<h1 style="color:blue;font-size:46px;text-align:center">CSC Ideation Portal</h1><br><br>

<br><br>
<p style="font-size:22px;text-align:center">The Manage Users tab allows you to add, edit and delete users from the portal.</p>
<p style="font-size:22px;text-align:center">The Manage Groups tab allows you to create, edit and delete groups.</p>
<p style="font-size:22px;text-align:center">The Manage Forum tab takes you to the index page of JForum.</p>
</div>
</div>
</body>
</html>