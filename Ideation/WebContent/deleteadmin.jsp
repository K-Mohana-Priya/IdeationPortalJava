...
$(document).ready(function(){
   ...
   $("#delbut").click(function(){
	   var form=document.getElementById("reg");
  		...
  		document.location="removeusercontroller?uid="+v;
   });
...
<a href="viewadmins.jsp" class='col-lg-12 col-md-12 col-sm-12' style="background-color:#dfdfdf">Modify Admins</a><br>
<a href="addadmin.jsp" class='col-lg-12 col-md-12 col-sm-12'>Add Admin</a><br>

</div>
<div class="col-lg-10 col-md-10 col-sm-9 equaliseheight">
<form role="form" id="reg" action="editusercontroller" method="post" onsubmit="return validate()">
<input type="hidden" value="${requestScope.euser.getUser_id()}" name="uid" id="uid"/> 
    
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="uname">User Name:</label>
      <input type="text" class="form-control" id="uname" name="uname" value="${requestScope.euser.getUser_name()}" onblur="validateName()">
      <span id=fname_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="udoj">Date Joined(yyyy-mm-dd):</label>
      <input type="text" class="form-control" id="udoj" name="udoj"  value="${requestScope.euser.getDate_joined()}"onblur="validateDOJ()" >
      <span id=fdoj_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="uemail">Email Id:</label>
      <input type="text" class="form-control" id="uemail" name="uemail" value="${requestScope.euser.getEmail()}" onblur="validateEmail()">
      <span id=fmail_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="umobile">Mobile No:</label>
      <input type="text" class="form-control" id="umobile" name="umobile" value="${requestScope.euser.getMobile_no()}" onblur="validateNumber()">
      <span id=fno_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="ulevel">Level:</label>
      <input type="text" class="form-control" id="ulevel" name="ulevel" value="${requestScope.euser.getLevel()}" onblur="validateLevel()">
      <span id=flevel_msg style="color:red"></span><br>
    </div><br>
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 col-centered">
      <label for="ulayer">Layer:</label>
      <input type="text" class="form-control" id="ulayer" name="ulayer" value="${requestScope.euser.getLayer()}" onblur="validateLayer()">
      <span id=flayer_msg style="color:red"></span><br>
    </div><br>
    
    <div class="centered">
    <button type="submit" class="btn btn-default" id="butt">Edit Admin</button>
    <button type="button" class="btn btn-default" id="delbut">Delete Admin</button>
