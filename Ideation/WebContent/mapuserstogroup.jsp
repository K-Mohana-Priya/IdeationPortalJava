...
<script>
history.pushState(null,null,"mapuserstogroup.jsp");
...
$( document ).ready(function() {
    ...
    var val=document.getElementById("gid").value;
    var gname=document.getElementById("gname").value;
    var url1="showuserstoaddcontroller?val="+val;
    var url2="showuserstoremovecontroller?val="+val;
    ...
    $("#add").click(function(){
    	$("#sel1 option:selected").each(function() {
            var v=($(this).val());
            document.getElementById("sel1").removeChild(this);
        	var control="addtogroupcontroller?uid="+v+"&gid="+val+"&gname="+gname;
        	 $.post(control, function(data){
        	    	var x = document.createElement("OPTION");
        	        var t = document.createTextNode(v);
        	        x.appendChild(t);
        	        document.getElementById("sel2").appendChild(x);
        	    	});
        });
    });
    ...
    $("#remove").click(function(){
    	$("#sel2 option:selected").each(function() {
            var v=($(this).val());
            document.getElementById("sel2").removeChild(this);
          	var control="removefromgroupcontroller?uid="+v+"&gid="+val+"&gname="+gname;
          	 $.post(control, function(data){
          	    	var x = document.createElement("OPTION");
          	        var t = document.createTextNode(v);
          	        x.appendChild(t);
          	        document.getElementById("sel1").appendChild(x);
          	    	});
...
<title>Map Users to Group</title>
</head>
<body>
...
<h3>Group Name : ${requestScope.group.getGroup_name()}</h3>
<input type="hidden" id="gid" name="gid" value="${requestScope.group.getGroup_id()}"/>
<input type="hidden" id="gname" name="gname" value="${requestScope.group.getGroup_name()}"/>
<div class="col-lg-5 col-md-5 col-sm-5">

      <select multiple class="form-control" name="sel1" id="sel1" size="20">
      </select>
     
</div>
<div class="col-lg-2 col-md-2 col-sm-2"><br><br><br>
<button class="btn btn-default" id="add" name="add">Add</button><br><br>
<button class="btn btn-default" id="addall" name="addall">Add All</button><br><br>
<button class="btn btn-default" id="remove" name="remove">Remove</button><br><br>
<button class="btn btn-default" id="removeall" name="removeall">Remove All</button><br><br>
</div>
<div class="col-lg-5 col-md-5 col-sm-5">

      <select multiple class="form-control" name="sel2" id="sel2" size="20">
       </select>
      </div><br><br>
      <div class="centered">
      <a class="btn btn-default" href="viewgroups.jsp">Finish</a></div>
</div>
</body>
</html>