...
<script>
history.pushState(null,null,"editgroups.jsp");
window.addEventListener('popstate',function(event){
	history.pushState(null,null,"editgroups.jsp");
});
$( document ).ready(function() {
    
    var url="groupdisplaycontroller";
...
{
	var v = s.cells[1].innerHTML;
	document.location="editgroupscontroller?val="+v;
}
...
<a href="editgroups.jsp" class='col-lg-12 col-md-12 col-sm-12' style="background-color:#dfdfdf">Modify Group</a><br>
...
<h3>Select Group Id to Edit</h3><br>
